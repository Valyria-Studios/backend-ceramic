...
import { AnchorStatus, EventType, SignatureStatus, SignatureUtils, StreamUtils, UnreachableCaseError, } from '@ceramicnetwork/common';
...
export class ModelInstanceDocumentHandler {
    ...
    async _validateContent(ceramic, model, content, genesis, payload) {
        if (genesis &&
