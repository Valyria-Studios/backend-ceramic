...
export declare function makeAnchorService(config: CeramicConfig, ethereumRpcUrl: string | undefined, network: Networks, logger: DiagnosticsLogger, signer: CeramicSigner): AnchorService;
