...
import { StreamUtils, LoggerProvider, SyncOptions, CeramicSigner, } from '@ceramicnetwork/common';
...
export class Ceramic {
    ...
    static _processConfig(ipfs, config) {
        ...
        const anchorService = makeAnchorService(config, ethereumRpcUrl, networkOptions.name, logger, signer);
        ...
        const repository = new Repository(streamCacheLimit, concurrentRequestsLimit, feed, reconApi, logger);
        const shutdownSignal = new ShutdownSignal();
        const dispatcher = new Dispatcher(ipfs, networkOptions, repository, logger, pubsubLogger, shutdownSignal, !config.disablePeerDataSync, maxQueriesPerSecond, reconApi);
