...
export class EthereumAnchorService {
    constructor(anchorServiceUrl, ethereumRpcUrl, logger, sendRequest = fetchJson, enableAnchorPollingLoop = true) {
        ...
        __classPrivateFieldSet(this, _EthereumAnchorService_cas, new RemoteCAS(logger, anchorServiceUrl, sendRequest), "f");
    ...
    async requestAnchor(carFile) {
        ...
        doNotWait(__classPrivateFieldGet(this, _EthereumAnchorService_cas, "f").create(carFileReader), __classPrivateFieldGet(this, _EthereumAnchorService_logger, "f"));
        return {
...
export class AuthenticatedEthereumAnchorService extends EthereumAnchorService {
    constructor(auth, anchorServiceUrl, ethereumRpcUrl, logger, enableAnchorPollingLoop = true) {
        super(anchorServiceUrl, ethereumRpcUrl, logger, auth.sendAuthenticatedRequest.bind(auth), enableAnchorPollingLoop);
        this.auth = auth;
    }
    async init(store, eventHandler) {
