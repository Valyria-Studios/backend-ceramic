...
export async function createDispatcher(ipfs, pubsubTopic) {
    ...
    return new Dispatcher(ipfs, { pubsubTopic, id: 0, name: Networks.INMEMORY }, repository, logger, loggerProvider.makeServiceLogger('pubsub'), shutdownSignal, true, 10, fauxReconApi, new TaskQueue());
}
