...
export class StreamUpdater {
    ...
    async applyCommitFromUser(state, commit) {
        ...
        const commitCid = await this.commitStorer.storeDataEvent(commit, commitHeight, StreamUtils.streamIdFromState(state), state.metadata.controllers, state.metadata.model);
