...
import type { ModelDefinition, ModelRelationsDefinitionV2, ModelViewsDefinitionV2 } from '@ceramicnetwork/stream-model';
import type { CustomRuntimeScalarType, InternalCompositeDefinition, JSONSchema, RuntimeCompositeDefinition, RuntimeList, RuntimeObjectField, RuntimeObjectFields, RuntimeReference, RuntimeScalar, RuntimeViewReference } from '@composedb/types';
import type { AnySchema, ScalarSchema } from '../types.js';
type EnumSchema = JSONSchema.String & {
    title: string;
    enum: Array<string>;
};
/** @internal */
