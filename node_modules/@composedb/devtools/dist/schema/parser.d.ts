...
export declare class SchemaParser {
    ...
    _parseObject(type: GraphQLInterfaceType | GraphQLObjectType, directives: Array<DirectiveAnnotation>): ObjectDefinition;
    _parseObjectFields(type: GraphQLInterfaceType | GraphQLObjectType, directives: Array<DirectiveAnnotation>): IntermediaryObjectDefinition;
    ...
    _parseViews(objectName: string, fieldName: string, type: GraphQLType, directives: Array<DirectiveAnnotation>, objectFields: GraphQLFieldMap<unknown, unknown>): ViewFieldDefinition | void;
    _parseListType(objectName: string, fieldName: string, type: GraphQLList<GraphQLType>, required: boolean, directives: Array<DirectiveAnnotation>, hasCreateModel: boolean): DefinitionWithReferences<ListFieldDefinition>;
    _parseItemType(objectName: string, fieldName: string, type: GraphQLType, directives: Array<DirectiveAnnotation>, hasCreateModel: boolean): DefinitionWithReferences<ItemDefinition>;
